# Pedestrian Cell Phone Usage Detection - Frontend
> Alias: **You Focus Your Walk**

## Personnel

- **Group Members:** [Huang Yanzhen DC126732](https://github.com/YanzhenHuang), [Mai Jiajun DC127853](https://github.com/SpinningMai)

- **Supervisor:** Prof. Bob Zhang

<img src="https://s2.loli.net/2025/04/15/lPhs8WeTK6uLFMI.png" alt="Demo Image">
...
>
> To support the throughput of WebSocket, the frontend is run LOCALLY where the inference backend run.
> It does not run on the server of storage backend that stores faces.
